...
class LighttrackMulti(object):
    """Device-agnostic version of Lighttrack for multi-object tracking"""
    def __init__(self, info, device='cuda', even=0):
        super(LighttrackMulti, self).__init__()
        self.info = info
